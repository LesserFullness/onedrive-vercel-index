...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'Yong@wouldfull.onmicrosoft.com',
  ...
  email: 'mailto:wouldfull@outlook.com',
